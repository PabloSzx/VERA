...
function viewEmotional() { 
    ...
    if (startViewEmotional) {
        ...
        getIntroductionFactor ( "viewSurveyOneEmotional", "SurveyOne", "Emotional", " ", generateBtnSectionOne); //Ejecuto la función que genera el texto de introducción y le paso como parametro la func para generar el btn para mostrar grafico 1
    }
}
