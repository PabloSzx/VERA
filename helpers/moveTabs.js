...
function openMeAuto(inside, btn){ // Cambio de pestaña Dimensiones Autoconcepto //
    let loginId = localStorage.getItem("idStudent");  // id del usuario
    track(loginId,btn,"");
...
function  openMeLS (inside, btn) { //Cambio de pestañas dimensiones de Estrategias de aprendizaje //
    let loginId = localStorage.getItem("idStudent");  // id del usuario
    track(loginId,btn,"");
...
function  openMeComponent (inside, btn) { //Cambio de pestañas dimensiones de Estrategias de aprendizaje //
    let loginId = localStorage.getItem("idStudent");  // id del usuario
    track(loginId,btn,"");
    var content = document.getElementsByClassName("containerDimensionSurveyTwoComponent");
    var selconceptBtn = document.getElementsByClassName("buttonSurveyTwoComponent")
